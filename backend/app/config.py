...
class Settings(BaseSettings):
    ...
    app_name: str = "India Financials Copilot"
    ...
    gemini_agent_request_limit: int = 20
    gemini_agent_temperature: float = 0.0
    ...
    retrieval_fts_keyword_model: str = "gemini-2.5-flash"
